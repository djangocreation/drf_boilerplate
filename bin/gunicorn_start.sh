...
DJANGODIR=$project_root/project             # Django project directory
...
# CONFIGURATION SUR LE SQUELETTE DJANGO
NUM_WORKERS=3                                     # how many worker processes should Gunicorn spawn
DJANGO_SETTINGS_MODULE=conf.base             # which settings file should Django use
